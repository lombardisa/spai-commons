...
public interface NotificationAddressee extends Serializable {
	...
	/**
	 * If the notification is addressed to all users of a company, get the company id.
	...
	/**
	 * If the notification status is {@link Status#ERROR}, get the error description.
	 * @return Optional error description
	 */
	Optional<String> getError();

	/**
	 * If the notification status is {@link Status#ERROR}, get the error localization message code.
